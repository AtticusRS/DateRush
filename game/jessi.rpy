...
label jessi:
    ...
    scene outsidebar
    t "Smoke lingers in the air outside this shabby bar. A bouncer glances your way before going back to scold the familiar woman."
    t "Although, while he was looking at you, you see that your date slipped on by into the sketchy bar."
menu:
    "Talk to the Bouncer":
        ...
        b "Humph! She ain't suppose to be here either."
        jump bouncerconvo
